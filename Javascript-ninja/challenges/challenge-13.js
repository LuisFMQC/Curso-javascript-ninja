...
brasil.unshift('Amazônia', 'Pará', 'Acre');
...
*/
var newSul = brasil.filter(function (item, index){
...
var nordeste = ['Maranhão', 'Piauí', 'Rio Grande do Norte', 'Paraíba', 'Pernambuco', 'Alagoas', 'Sergipe', 'Bahia', 'Ceará'];
